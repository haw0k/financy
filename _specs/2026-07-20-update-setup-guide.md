...
- `CLOUD_SETUP.md` contains an up-to-date list of all required environment variables with descriptions.
...
- All existing links in `CLOUD_SETUP.md` still resolve to the correct internal or external targets.
