...
- Should the database triggers that manage admin approval status (set `pending` on signup and auto-approve on email confirmation) be reviewed in light of this change? You decide.
