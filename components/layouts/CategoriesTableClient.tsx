...
import { NewButton, Select, SelectContent, SelectItem, SelectTrigger, SelectValue, showError } from '@/components/ui'
  ...
  return (
    <div className='flex flex-col gap-6'>
      ...
      <Card>
        ...
        <CardContent className='flex flex-col gap-6'>
          {isCtShowForm && (
            <form onSubmit={handleCtSubmit} className='mb-6 space-y-4 rounded-xl border bg-card p-6'>
              <fieldset className='min-w-0 space-y-4 rounded-lg border px-4 pb-4'>
                <legend className='px-2 text-sm font-medium text-foreground'>
